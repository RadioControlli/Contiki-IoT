...
#define BOARD_IOID_LED_3          IOID_25 //ADD LED
#define BOARD_IOID_LED_4          IOID_UNUSED //ADD LED 27
...
* @{
 */                                          
#define BOARD_IOID_UART_RX        IOID_3
 ...
 * @{
 */
#define BOARD_IOID_KEY_LEFT       IOID_UNUSED // PIN 15 
#define BOARD_IOID_KEY_RIGHT      IOID_UNUSED // PIN 18
#define BOARD_IOID_KEY_UP         IOID_UNUSED // PIN 19
#define BOARD_IOID_KEY_DOWN       IOID_UNUSED // PIN 12
#define BOARD_IOID_KEY_SELECT     IOID_UNUSED // PIN 11
...
#define BOARD_IOID_LCD_CS         IOID_11 //CS 
 ...
 * @{
 */
#define BOARD_IOID_ALS_PWR        IOID_30 // SERVE PER COMUNIC.RADIO
#define BOARD_IOID_ALS_OUT        IOID_29 // SERVE PER COMUNIC.RADIO
 ...
 * @{
 */
#define BOARD_STRING "RC-CC1310-DK"
/** @} */
/*---------------------------------------------------------------------------*/
#endif /* BOARD_H_ */
/*---------------------------------------------------------------------------*/
